exports.run = (client, message, args) => {
    ...
    const getAnswer = (rnd) => {
        ...
        if (rnd < 85) message.channel.send(getConAnswer()).catch(console.error); //getConAnswer
        else if (rnd < 90) message.channel.send(getWinAnswer()).catch(console.error); //getWinAnswer
        else if (rnd < 100) message.channel.send(getLoseAnswer()).catch(console.error); //getLoseAnswer
