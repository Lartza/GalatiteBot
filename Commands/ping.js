exports.run = (client, message, args) => {
    ...
    //winning Conditions
        ...
        message.channel.send("-Ohh no! " + name + " missed. **Puff** It turns out, that " + name + " was Sheorogath in disguise the WHOLE TIME! Since Sheo is threatening me with a spoon right now: " + name + "(Sheo) wins!!").catch(console.error);
